...
export declare class SourceControlImportService {
    ...
    getRemoteCredentialsFromFiles(context: SourceControlContext): Promise<Array<ExportableCredential & {
        filename: string;
    }>>;
    getLocalCredentialsFromDb(context: SourceControlContext): Promise<Array<ExportableCredential & {
        filename: string;
    }>>;
