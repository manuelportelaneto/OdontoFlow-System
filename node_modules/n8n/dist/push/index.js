    ...
    handleRequest(req, res) {
        ...
        if (!pushRef) {
            ...
            if (expectedHost !== originHost) {
                this.logger.warn(`Origin header does NOT match the expected origin. (Origin: "${originHost}", Expected: "${expectedHost}")`, { headers: (0, pick_1.default)(headers, ['host', 'origin', 'x-forwarded-proto', 'x-forwarded-host']) });
                connectionError = 'Invalid origin!';
            }
        }
        if (connectionError) {
