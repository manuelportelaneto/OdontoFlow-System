...
export declare class Server extends AbstractServer {
    ...
    constructor(loadNodesAndCredentials: LoadNodesAndCredentials, postHogClient: PostHogClient, eventService: EventService, instanceSettings: InstanceSettings, licenseState: LicenseState);
    start(): Promise<void>;
